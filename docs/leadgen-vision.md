...
| PB3 — Monorepo continuity sequence | **Phases 1–3 DONE** on dbhub 2026-05-20 (live cutover 2026-05-21T02:00:53Z, ~1s downtime, 244 tests + ruff green in new layout); Phase 4 (decom old layout) deferred 1–2 weeks pending a clean weekly cron cycle | [PB3-monorepo-continuity.md](PB3-monorepo-continuity.md) | Box access for parallel cloudflared + systemd edits; ~10 hrs across 2–3 calendar days |
